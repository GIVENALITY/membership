...
<head>
    ...
    <title>Login - Membership MS</title>
...
<body>
    ...
    <div class="container-xxl">
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner" style="max-width: 500px; width: 100%;">
                <!-- Register -->
                <div class="card">
                    <div class="card-body">
                        <!-- Logo -->
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to Membership MS! 👋</h4>
                        <p class="mb-4">Please sign-in to your hotel account</p>

  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Edit Membership Type: {{ $membershipType->name }}</h4>
      </div>
      <div class="card-body">
        @if ($errors->any())
        ...
        <form method="POST" action="{{ route('membership-types.update', $membershipType) }}" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <select class="form-select @error('billing_cycle') is-invalid @enderror" 
                ...
                <option value="monthly" {{ old('billing_cycle', $membershipType->billing_cycle) == 'monthly' ? 'selected' : '' }}>Monthly</option>
                <option value="yearly" {{ old('billing_cycle', $membershipType->billing_cycle) == 'yearly' ? 'selected' : '' }}>Yearly</option>
              </select>
              @error('billing_cycle')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="number" class="form-control @error('price') is-invalid @enderror" 
                     ...
                     value="{{ old('price', $membershipType->price) }}" required>
              @error('price')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            <div class="col-md-6 mb-3">
              ...
              <input type="number" class="form-control @error('discount_rate') is-invalid @enderror" 
                     ...
                     placeholder="5.0" value="{{ old('discount_rate', $membershipType->discount_rate) }}" required>
              @error('discount_rate')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control @error('description') is-invalid @enderror" 
                      ...
                      placeholder="Describe this membership type...">{{ old('description', $membershipType->description) }}</textarea>
            @error('description')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="number" class="form-control @error('max_visits_per_month') is-invalid @enderror" 
                     ...
                     placeholder="Leave empty for unlimited" value="{{ old('max_visits_per_month', $membershipType->max_visits_per_month) }}">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                     ...
                     value="{{ old('sort_order', $membershipType->sort_order) }}">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-6 mb-3">
                  ...
                  <input type="number" class="form-control @error('points_required_for_discount') is-invalid @enderror" 
                         ...
                         placeholder="5" value="{{ old('points_required_for_discount', $membershipType->points_required_for_discount) }}">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="number" class="form-control @error('consecutive_visits_for_bonus') is-invalid @enderror" 
                         ...
                         placeholder="5" value="{{ old('consecutive_visits_for_bonus', $membershipType->consecutive_visits_for_bonus) }}">
              ...
              <div class="row">
                <div class="col-md-6 mb-3">
                  ...
                  <input type="number" class="form-control @error('consecutive_visit_bonus_rate') is-invalid @enderror" 
                         ...
                         placeholder="20.0" value="{{ old('consecutive_visit_bonus_rate', $membershipType->consecutive_visit_bonus_rate) }}">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="number" class="form-control @error('birthday_discount_rate') is-invalid @enderror" 
                         ...
                         placeholder="25.0" value="{{ old('birthday_discount_rate', $membershipType->birthday_discount_rate) }}">
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-check">
                    ...
                    <input class="form-check-input" type="checkbox" id="has_special_birthday_discount" 
                           ...
                           {{ old('has_special_birthday_discount', $membershipType->has_special_birthday_discount) ? 'checked' : '' }}>
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-check">
                    ...
                    <input class="form-check-input" type="checkbox" id="has_consecutive_visit_bonus" 
                           ...
                           {{ old('has_consecutive_visit_bonus', $membershipType->has_consecutive_visit_bonus) ? 'checked' : '' }}>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      <div class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" id="points_reset_after_redemption" 
                               ...
                               {{ old('points_reset_after_redemption', $membershipType->points_reset_after_redemption) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="number" class="form-control @error('points_reset_threshold') is-invalid @enderror" 
                             ...
                             placeholder="Leave empty for immediate reset" value="{{ old('points_reset_threshold', $membershipType->points_reset_threshold) }}">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="form-control @error('points_reset_notes') is-invalid @enderror" 
                              ...
                              placeholder="Optional notes about points reset policy...">{{ old('points_reset_notes', $membershipType->points_reset_notes) }}</textarea>
              ...
              <div class="mb-3">
                ...
                <div id="progression-container">
                  @if(old('progression_visits') && old('progression_discounts'))
                    @for($i = 0; $i < count(old('progression_visits')); $i++)
                      <div class="progression-item mb-2">
                        <div class="row">
                          <div class="col-md-6">
                            <input type="number" class="form-control" name="progression_visits[]" 
                                   placeholder="Number of visits" min="1" value="{{ old('progression_visits')[$i] }}">
                          </div>
                          <div class="col-md-5">
                            <input type="number" class="form-control" name="progression_discounts[]" 
                                   placeholder="Discount %" step="0.1" min="0" max="100" value="{{ old('progression_discounts')[$i] }}">
                          </div>
                          <div class="col-md-1">
                    ...
                    @endfor
                  @elseif($membershipType->discount_progression)
                    @foreach($membershipType->discount_progression as $progression)
                      <div class="progression-item mb-2">
                        <div class="row">
                          <div class="col-md-6">
                            <input type="number" class="form-control" name="progression_visits[]" 
                                   placeholder="Number of visits" min="1" value="{{ $progression['visits'] ?? '' }}">
                          </div>
                          <div class="col-md-5">
                            <input type="number" class="form-control" name="progression_discounts[]" 
                                   placeholder="Discount %" step="0.1" min="0" max="100" value="{{ $progression['discount'] ?? '' }}">
                          </div>
                          <div class="col-md-1">
                            <button type="button" class="btn btn-outline-danger remove-progression">
                              <i class="icon-base ri ri-delete-bin-line"></i>
          ...
          <div class="mb-3">
            ...
            <div id="perks-container">
              @if(old('perks'))
                ...
                @endforeach
              @else
                @foreach($membershipType->perks as $perk)
                  <div class="perk-item mb-2">
                    <div class="input-group">
                      <input type="text" class="form-control" name="perks[]" 
                             value="{{ $perk }}" required>
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              ...
              @if($membershipType->card_template_image)
                <div class="mb-3">
                  <label class="form-label">Current Template</label>
                  <div class="border rounded p-2">
                    <img src="{{ $membershipType->card_template_url }}" alt="Card Template" class="img-fluid" style="max-height: 200px;">
                  </div>
                </div>
              @endif
              ...
              <div class="mb-3">
                ...
                <small class="text-muted">Upload a PNG, JPG, or JPEG image (max 2MB) to replace current template</small>
              ...
              <div class="mb-3">
                ...
                <div id="field-mappings-container">
                  @if(old('card_field_mappings'))
                    @foreach(old('card_field_mappings') as $index => $mapping)
                      <div class="field-mapping-item mb-2">
                        <div class="row">
                          <div class="col-md-4">
                            <select class="form-select" name="card_field_mappings[{{ $index }}][field]">
                              <option value="">Select field</option>
                              @foreach(\App\Models\MembershipType::getAvailableMemberFields() as $key => $label)
                                <option value="{{ $key }}" {{ $mapping['field'] == $key ? 'selected' : '' }}>{{ $label }}</option>
                              @endforeach
                            </select>
                          </div>
                          <div class="col-md-2">
                            <input type="number" class="form-control" name="card_field_mappings[{{ $index }}][x]" 
                                   placeholder="X" min="0" title="X coordinate" value="{{ $mapping['x'] ?? '' }}">
                          </div>
                          <div class="col-md-2">
                            <input type="number" class="form-control" name="card_field_mappings[{{ $index }}][y]" 
                                   placeholder="Y" min="0" title="Y coordinate" value="{{ $mapping['y'] ?? '' }}">
                          </div>
                          <div class="col-md-2">
                            <input type="number" class="form-control" name="card_field_mappings[{{ $index }}][font_size]" 
                                   placeholder="Font" min="8" max="72" value="{{ $mapping['font_size'] ?? 16 }}" title="Font size">
                          </div>
                          <div class="col-md-2">
                    ...
                    @endforeach
                  @elseif($membershipType->card_field_mappings)
                    @foreach($membershipType->card_field_mappings as $index => $mapping)
                      <div class="field-mapping-item mb-2">
                        <div class="row">
                          <div class="col-md-4">
                            <select class="form-select" name="card_field_mappings[{{ $index }}][field]">
